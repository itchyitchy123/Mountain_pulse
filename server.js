...
function openApiDocument(){
  ...
  return {
    openapi:'3.1.0',info:{title:'MountainPulse Prototype API',version:'1.0.0',description:'Read-only simulated data. Not an official resort operations source.'},
    servers:[{url:'/api/v1'}],
    paths:{
...
server.listen(port,host,()=>console.log(`MountainPulse running at http://${host}:${port}`));
